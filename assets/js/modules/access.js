  ...
  function phrase(key) {
    ...
    const dictionary = {
      uk: {
        ...
        codeSuccess: "Тариф підключено. Доступ відкрито. Можеш закрити це вікно й перейти до модулів.",
      ...
      en: {
        ...
        codeSuccess: "Plan connected. Access unlocked. You can close this window and go to the modules.",
      ...
      ru: {
        ...
        codeSuccess: "Тариф подключен. Доступ открыт. Можешь закрыть это окно и перейти к модулям.",
