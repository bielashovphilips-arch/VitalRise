(function () {
  ...
  const pages = {
    privacy: {
      uk: {
        title: "Політика конфіденційності | VitalRise",
        description: "Політика конфіденційності VitalRise: які дані обробляє сайт, як вони використовуються і як користувач контролює збережену інформацію.",
      ...
      en: {
        ...
        paragraphs: [
          ...
          "With the user's consent, the site may use Google Analytics and the Meta Pixel to measure advertising effectiveness and understand which sections work, where users stop, and what should be improved. Form data such as sex, age, body measurements, health information, and calculation results are not sent to advertising systems as advertising-event parameters.",
    ...
    terms: {
      uk: {
        title: "Умови використання | VitalRise",
        description: "Умови використання VitalRise: правила доступу, оплати, автопродовження, відповідальності користувача, контенту та обмежень сервісу.",
    ...
    disclaimer: {
      uk: {
        title: "Медичний та АС/ААС дисклеймер | VitalRise",
        description: "Медичний та АС/ААС дисклеймер VitalRise: освітній характер матеріалів, ризики фармакології і необхідність консультації лікаря.",
