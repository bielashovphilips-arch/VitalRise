(function () {
  ...
  Object.assign(translations.uk, {
    ...
    "pricing.freeCopy": "Для людини, яка хоче побачити логіку системи без оплати. Free не відкриває готовий тижневий план — він входить у Start.",
    ...
    "pricing.freeBackText": "Дає швидке демо логіки: калькулятор, приклад денного раціону, базову структуру тренувань і спортпіт. Готовий 7-денний план відкривається у Start.",
    ...
    "faq.a2": "Безкоштовно можна подивитися логіку системи, демо-приклад денного раціону, базову структуру тренувань і спортпіт. Повний тиждень харчування, тренувань і PDF-звіт — у Start.",
    ...
    "pricing.freeItem2": "1 демо-приклад денного раціону",
    "pricing.freeItem3": "Приклад базової структури тренувань",
    "pricing.freeItem4": "Частковий атлас вправ",
    "pricing.freeItem5": "Базовий модуль спортпіту",
    "pricing.freeCta": "Подивитися демо",
  ...
  Object.assign(translations.en, {
    ...
    "pricing.freeCopy": "For someone who wants to see the system logic without payment. Free does not unlock a ready weekly plan — that starts with Start.",
    ...
    "pricing.freeBackText": "A quick demo of the logic: calculator, one sample meal day, basic training structure, and supplements. The ready 7-day plan unlocks in Start.",
    ...
    "faq.a2": "Free shows the system logic, one demo sample meal day, basic training structure, and supplements. The full week of nutrition, training, and PDF report is in Start.",
    ...
    "pricing.freeItem2": "1 demo sample day of nutrition",
    "pricing.freeItem3": "Sample basic training structure",
    "pricing.freeItem4": "Partial exercise atlas",
    "pricing.freeItem5": "Basic supplements module",
    "pricing.freeCta": "View demo",
  ...
  Object.assign(translations.ru, {
    ...
    "pricing.freeCopy": "Для человека, который хочет увидеть логику системы без оплаты. Free не открывает готовый недельный план — он входит в Start.",
    ...
    "pricing.freeBackText": "Быстрое демо логики: калькулятор, пример дневного рациона, базовая структура тренировок и спортпит. Готовый 7-дневный план открывается в Start.",
    ...
    "faq.a2": "Бесплатно можно посмотреть логику системы, демо-пример дневного рациона, базовую структуру тренировок и спортпит. Полная неделя питания, тренировок и PDF-отчет — в Start.",
    ...
    "pricing.freeItem2": "1 демо-пример дневного рациона",
    "pricing.freeItem3": "Пример базовой структуры тренировок",
    "pricing.freeItem4": "Частичный атлас упражнений",
    "pricing.freeItem5": "Базовый модуль спортпита",
    "pricing.freeCta": "Посмотреть демо",
    "pricing.badge": "Оптимально",
    "pricing.startPrice": "499 грн",
