(function () {
  ...
  const automaticTextTranslations = {
    ...
    // Footer
    footerDeveloperLabel: "Розробник сайту",
    footerDeveloperAria: "Розробник сайту Bielashov Yevgen",
  ...
  Object.assign(translations.uk, {
    ...
    "nav.pricing": "Тарифи",
    "nav.writeCoach": "Написати тренеру",
    ...
    "pricing.freeBackTitle": "Від цифри до плану",
    "pricing.freeBackText": "Free показує лише твій базовий енергетичний орієнтир. Раціон, тренування, корекції та PDF відкриваються після оплати Start.",
    ...
    "pricing.freeTitle": "Персональний старт",
    "pricing.freeItem1": "Персональний орієнтир калорій",
    "pricing.freeItem2": "Розрахунок за твоїми даними",
    "pricing.freeItem3": "Без раціону та програми тренувань",
    "pricing.freeItem4": "Відкриті матеріали Влогу",
    "pricing.freeItem5": "Базові знання про відновлення",
    "pricing.freeCta": "Розрахувати калорії",
  ...
  Object.assign(translations.en, {
    footerDeveloperLabel: "Website developer",
    footerDeveloperAria: "Website developer Bielashov Yevgen",
    ...
    "pricing.freeBackTitle": "From a number to a plan",
    "pricing.freeBackText": "Free shows only your basic energy estimate. Nutrition, training, adjustments, and PDF unlock after purchasing Start.",
    ...
    "pricing.freeTitle": "Personal starting point",
    "pricing.freeItem1": "Personal calorie estimate",
    "pricing.freeItem2": "Calculation from your details",
    "pricing.freeItem3": "No meal plan or training program",
    "pricing.freeItem4": "Open Vlog materials",
    "pricing.freeItem5": "Recovery fundamentals",
    "pricing.freeCta": "Calculate calories",
  ...
  Object.assign(translations.ru, {
    footerDeveloperLabel: "Разработчик сайта",
    footerDeveloperAria: "Разработчик сайта Bielashov Yevgen",
    ...
    "nav.pricing": "Тарифы",
    "nav.writeCoach": "Написать тренеру",
    ...
    "pricing.freeBackTitle": "От цифры к плану",
    "pricing.freeBackText": "Free показывает только базовый ориентир по энергии. Рацион, тренировки, корректировки и PDF открываются после оплаты Start.",
    ...
    "pricing.freePrice": "0 грн",
    "pricing.freeTitle": "Персональный старт",
    "pricing.freeItem1": "Персональный ориентир по калориям",
    "pricing.freeItem2": "Расчёт по вашим данным",
    "pricing.freeItem3": "Без рациона и программы тренировок",
    "pricing.freeItem4": "Открытые материалы Влога",
    "pricing.freeItem5": "Базовые знания о восстановлении",
    "pricing.freeCta": "Рассчитать калории",
    "pricing.badge": "Оптимально",
    "pricing.startPrice": "499 грн",
