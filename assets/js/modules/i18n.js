(function () {
  ...
  const translations = {
    uk: {
      ...
      "brands.title": "Виробники спортпіту та wellness-добавок",
      "brands.text": "Партнерські бренди для підбору протеїну, креатину, вітамінів і відновлення",
    ...
    en: {
      ...
      "brands.title": "Sports nutrition and wellness brands",
      "brands.text": "Partner brands for protein, creatine, vitamins, and recovery support",
    ...
    ru: {
      ...
      "brands.title": "Производители спортпита и wellness-добавок",
      "brands.text": "Партнерские бренды для подбора протеина, креатина, витаминов и восстановления",
  ...
  const automaticTextTranslations = {
    ...
    exChestFlyMachineCable: { uk: "Розведення в тренажері / кросовері", en: "Machine / cable fly", ru: "Разведение в тренажере / кроссовере" },
    exCableFly: { uk: "Зведення рук в кросовері", en: "Cable fly", ru: "Сведение рук в кроссовере" },
    exMachineCableFly: { uk: "Розведення в тренажері / кросовері", en: "Machine / cable fly", ru: "Разведения в тренажере / кроссовере" },
    ...
    cueAfter20: { uk: "Після 20 повторів ускладнюй", en: "After 20 reps, make it harder", ru: "После 20 повторов усложняй" },
    ...
    harderAfter20: { uk: "після 20 повторів ускладнюй варіацію", en: "after 20 reps, make the variation harder", ru: "после 20 повторов усложняй вариацию" },
    addSetOrDifficulty: { uk: "додавай підхід або складність", en: "add a set or difficulty", ru: "добавляй подход или сложность" },
  ...
  Object.assign(translations.uk, {
    ...
    "newsletter.title": "Отримати ранній доступ і знижку",
    "newsletter.text": "Email для оновлень, запуску нових модулів і першої персональної пропозиції.",
    "newsletter.placeholder": "Твій email",
    "newsletter.cta": "Підписатися",
    "pricing.freeCopy": "Для людини, яка хоче побачити логіку системи без ризику і одразу розрахувати базові орієнтири.",
    ...
    "pricing.freeBackText": "Дає швидку перевірку логіки: калорії, БЖВ, перший приклад раціону, базові тренування і спортпіт без оплати.",
    ...
    "pricing.backPointThirtyDays": "30 днів",
    ...
    "faq.label": "FAQ",
    "faq.title": "Перед оплатою",
    "faq.q1": "Коли відкривається доступ?",
    "faq.a1": "Після підтвердження оплати сервер видає персональний доступ для email, який був вказаний при оплаті.",
    "faq.q2": "Чи можна спочатку подивитися безкоштовно?",
    "faq.a2": "Так. Калькулятор, базовий раціон, спортпіт і частина тренувань доступні без оплати.",
    "faq.q3": "Що робити, якщо план не підходить?",
    "faq.a3": "План можна коригувати через check-in і 14-денний контроль прогресу.",
    ...
    "policy.refund": "Повернення коштів можливе до активації персонального доступу або якщо технічна помилка не була вирішена.",
    ...
    "pricing.freeItem2": "1 приклад денного раціону",
    "pricing.freeItem3": "Базова структура тренувань",
    "pricing.freeItem4": "Частковий атлас вправ",
    "pricing.freeItem5": "Базовий модуль спортпіту",
    "pricing.freeCta": "Спробувати безкоштовно",
    ...
    "pricing.premiumItem4": "Підтримка в чаті протягом місяця",
  ...
  Object.assign(translations.en, {
    ...
    "newsletter.title": "Get early access and a discount",
    "newsletter.text": "Email for updates, new module launches, and the first personal offer.",
    "newsletter.placeholder": "Your email",
    "newsletter.cta": "Subscribe",
    "pricing.freeCopy": "For someone who wants to see the system logic with no risk and calculate the first baseline targets.",
    ...
    "pricing.freeBackText": "A quick system check: calories, macros, one sample meal day, basic training, and supplements without payment.",
    ...
    "pricing.backPointThirtyDays": "30 days",
    "pricing.backPointCheckin": "Check-in",
    "pricing.backPointBlueprint": "Blueprint",
    ...
    "faq.label": "FAQ",
    "faq.title": "Before payment",
    "faq.q1": "When does access open?",
    "faq.a1": "After payment confirmation, the server issues personal access for the email used during checkout.",
    "faq.q2": "Can I view anything for free first?",
    "faq.a2": "Yes. The calculator, basic meal plan, supplements, and part of the training content are available for free.",
    "faq.q3": "What if the plan does not fit?",
    "faq.a3": "The plan can be adjusted through check-ins and 14-day progress control.",
    ...
    "policy.refund": "A refund is possible before personal access activation or if a technical issue is not resolved.",
    "payment.stepEmail": "Email",
    ...
    "pricing.freeItem2": "1 sample day of nutrition",
    "pricing.freeItem3": "Basic training structure",
    "pricing.freeItem4": "Partial exercise atlas",
    "pricing.freeItem5": "Basic supplements module",
    "pricing.freeCta": "Try for free",
    ...
    "pricing.premiumItem4": "Chat support for one month",
  ...
  Object.assign(translations.ru, {
    ...
    "newsletter.title": "Получить ранний доступ и скидку",
    "newsletter.text": "Email для обновлений, запуска новых модулей и первого персонального предложения.",
    "newsletter.placeholder": "Твой email",
    "newsletter.cta": "Подписаться",
    "pricing.freeCopy": "Для человека, который хочет увидеть логику системы без риска и сразу рассчитать базовые ориентиры.",
    ...
    "pricing.freeBackText": "Быстрая проверка логики: калории, БЖУ, первый пример рациона, базовые тренировки и спортпит без оплаты.",
    ...
    "pricing.backPointThirtyDays": "30 дней",
    "pricing.backPointCheckin": "Check-in",
    "pricing.backPointBlueprint": "Blueprint",
    ...
    "faq.label": "FAQ",
    "faq.title": "Перед оплатой",
    "faq.q1": "Когда открывается доступ?",
    "faq.a1": "После подтверждения оплаты сервер выдает персональный доступ для email, который был указан при оплате.",
    "faq.q2": "Можно сначала посмотреть бесплатно?",
    "faq.a2": "Да. Калькулятор, базовый рацион, спортпит и часть тренировок доступны без оплаты.",
    "faq.q3": "Что делать, если план не подходит?",
    "faq.a3": "План можно корректировать через check-in и 14-дневный контроль прогресса.",
    ...
    "policy.refund": "Возврат средств возможен до активации персонального доступа или если техническая ошибка не была решена.",
    "payment.stepEmail": "Email",
    "payment.stepPay": "Оплата",
    "payment.stepAccess": "Доступ",
    ...
    "pricing.freeItem2": "1 пример дневного рациона",
    "pricing.freeItem3": "Базовая структура тренировок",
    "pricing.freeItem4": "Частичный атлас упражнений",
    "pricing.freeItem5": "Базовый модуль спортпита",
    "pricing.freeCta": "Попробовать бесплатно",
    "pricing.badge": "Оптимально",
    "pricing.startPrice": "499 грн",
    ...
    "pricing.premiumItem4": "Поддержка в чате в течение месяца",
  ...
  function translate(key, language) {
    ...
    return dictionary[key] || translations[DEFAULT_LANGUAGE][key] || "";
  }
