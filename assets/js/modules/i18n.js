(function () {
  ...
  const translations = {
    uk: {
      ...
      "brands.text": "Тут може бути ваш логотип: спортпіт, лабораторії, харчування, екіпірування або wellness-сервіси",
    ...
    ru: {
      ...
      "brands.text": "Здесь может быть ваш логотип: спортпит, лаборатории, питание, экипировка или wellness-сервисы",
      "brands.slot1": "Ваш логотип",
  ...
  Object.assign(translations.uk, {
    ...
    "faq.a3": "Після підключення платіжного сервісу кнопки тарифів відкриватимуть оплату. Після підтвердження покупки доступ буде прив'язаний до email.",
    ...
    "faq.a8": "Після підключення оплати умови повернення будуть прописані окремо. Базовий принцип: якщо доступ не активований або технічну помилку не вирішено, покупка перевіряється вручну.",
  ...
  Object.assign(translations.en, {
    ...
    "faq.a3": "After the payment provider is connected, pricing buttons will open checkout. After purchase confirmation, access will be linked to the email.",
    ...
    "faq.a8": "After payments are connected, refund terms will be described separately. The basic principle: if access is not activated or a technical issue is not resolved, the purchase is checked manually.",
  ...
  Object.assign(translations.ru, {
    ...
    "faq.a3": "После подключения платежного сервиса кнопки тарифов будут открывать оплату. После подтверждения покупки доступ будет привязан к email.",
    ...
    "faq.a8": "После подключения оплаты условия возврата будут прописаны отдельно. Базовый принцип: если доступ не активирован или техническая ошибка не решена, покупка проверяется вручную.",
