const CACHE_NAME = "vitalrise-v212";
const RUNTIME_CACHE_NAME = "vitalrise-runtime-v204";
const APP_SHELL = [
  "./",
  "./index.html",
  "./nutrition.html",
  ...
  "./terms.html",
  "./disclaimer.html",
  "./assets/css/style.css?v=platform-modules-25",
  "./assets/images/labs-bloodwork-bg.webp",
  "./assets/images/nutrition-food-bg.webp",
  "./assets/images/vlog-dna-bg-photo.png",
  "./assets/images/exercises/seated-dumbbell-press-form.jpg",
  "./assets/images/exercises/t-bar-row-to-waist.webp",
  "./assets/images/exercises/cable-pullover-back.jpg",
  "./assets/js/modules/system.js",
  "./assets/js/modules/i18n.js?v=translation-audit-1",
  ...
  "./assets/js/modules/nutrition.js?v=free-cottage-meals-1",
  "./assets/js/modules/nutrition-render.js?v=free-cottage-meals-1",
  "./assets/js/modules/training.js",
  "./assets/js/modules/training-templates.js?v=training-days-6-1",
  ...
  "./assets/js/modules/training-builder.js?v=gym-muscle-order-1",
  "./assets/js/modules/exercise-atlas-data.js?v=cable-pullover-photo-1",
  "./assets/js/modules/exercise-atlas.js",
  "./assets/js/modules/labs.js",
  "./assets/js/modules/lab-protocols.js",
  "./assets/js/modules/progress-decision.js?v=biweekly-correction-1",
  "./assets/js/modules/blueprint.js",
  "./assets/js/modules/supplements.js?v=ecdysterone-1",
  "./assets/js/modules/coach.js?v=quick-profiles-2",
  "./assets/js/modules/access.js?v=analytics-1",
  "./assets/js/script.js?v=free-cottage-meals-1",
