const CACHE_NAME = "vitalrise-v280";
const RUNTIME_CACHE_NAME = "vitalrise-runtime-v227";
const APP_SHELL = [
  "./",
  "./index.html",
  "./nutrition.html",
  ...
  "./terms.html",
  "./disclaimer.html",
  "./assets/css/style.css?v=expanded-lab-report-1",
  ...
  "./assets/js/modules/access.js?v=wayforpay-form-1",
